require([], function (){
    ...
    var colorList = ["url(/img/guangzhou.png)", "url(/img/img01.png)", "url(/img/tianhequ_09.png)", "url(/img/img02.png)", "url(/img/img06.png)", "url(/img/guangzhou.png)", "url(/img/img06.png)", "url(/img/img02.png)", "url(/img/tianhequ_09.png)"];
    var id = Math.ceil(Math.random()*(colorList.length-1));
    // PC
    
    $("#container .left-col .overlay").css({"background-image": colorList[id],"opacity": .5});
    // Mobile
    $("#container #mobile-nav .overlay").css({"background-image": colorList[id],"opacity": .7});
